...
export declare type TFilterAction = "add" | "remove" | "clear";
export declare type TFilterType = "subtractive" | "additive";
...
export declare type FilterActions = IAddFilter | IRemoveFilter | IClearFilters;
